...
static inline auto CreateDirect3DDevice(IDXGIDevice* dxgi_device)
{
...
static inline auto CreateDirect3DSurface(IDXGISurface* dxgi_surface)
{
...
template <typename T>
static inline auto GetDXGIInterfaceFromObject(winrt::Windows::Foundation::IInspectable const& object)
{
