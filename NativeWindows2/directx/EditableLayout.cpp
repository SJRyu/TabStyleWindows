...
)
{
    ...
    else
    {
        ...
        DWRITE_FONT_STRETCH stretch = DWRITE_FONT_STRETCH_ULTRA_EXPANDED;
...
)
{
    ...
    if (hr == S_OK)
    {
        SafeRelease(currentLayout);
        newLayout->QueryInterface(currentLayout);
        newLayout->Release();
    }
...
)
{
    ...
    IDWriteTextLayout4* oldLayout = SafeAcquire(*currentLayout);
    ...
    IDWriteTextLayout4* newLayout = *currentLayout;
